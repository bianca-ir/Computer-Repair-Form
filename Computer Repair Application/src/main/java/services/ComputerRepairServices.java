...
public class ComputerRepairServices {
    ...
    public List<ComputerRepairRequest> getRepairedComputers(){
        return requestRepository.filterdByStatus(RequestStatus.Finished);

    }

    public List<ComputerRepairRequest> getRequestsByStatus(RequestStatus status){
        return requestRepository.filterdByStatus(status);
